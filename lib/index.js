...
const translations = require('./workers/translations');
...
// Translations
wrapper.translations.add = async (token, id, lang, data) => {
  return await translations.add(token, id, lang, data);
};

wrapper.translations.update = async (token, id, lang, data) => {
  return await translations.update(token, id, lang, data);
};
